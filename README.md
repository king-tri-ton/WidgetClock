...
Минималистичные настольные часы для Windows, написанные на Python с использованием PySide6.
Проект сделан для рабочего ПК — чтобы время всегда было видно, без лишних окон, панелей и отвлекающих элементов.

Приложение отображается поверх всех окон и выглядит как аккуратный виджет на рабочем столе.

## Возможности

* Окно без рамок и заголовка
* Поверх всех окон
* Полупрозрачный фон
* Несколько тем оформления
* Перетаскивание мышью
* Контекстное меню
* Добавление и удаление из автозагрузки Windows
* Работает как из `.py`, так и из собранного `.exe`
...
Проект лёгкий, понятный и легко дорабатывается.
